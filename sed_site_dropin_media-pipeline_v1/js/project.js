(function () {
  ...
  function ensureContainCSS(){
    if (document.getElementById("contain-css")) return;
    var css = ".detail-media.contain .ratio-169>img,.detail-media.contain .ratio-169>video{object-fit:contain;background:#000}";
    var style = document.createElement("style");
    style.id = "contain-css";
  ...
  function render(item, idx, list){
    ...
    if (item && item.fit === "contain" && detail){
      ensureContainCSS();
      detail.classList.add("contain");
    }
