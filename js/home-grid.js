...
(function(){
  ...
  function card(it){
    ...
    var primary = it.cover || (it.gallery && it.gallery[0]) || 'assets/work/placeholder-16x9.jpg';
  ...
  function renderMore(){
    ...
    // pad until something scrolls
    var root = scroller || document.documentElement;
    var scrolls = root.scrollHeight > root.clientHeight + 8;
    if (!scrolls && !done) renderMore();
  }
